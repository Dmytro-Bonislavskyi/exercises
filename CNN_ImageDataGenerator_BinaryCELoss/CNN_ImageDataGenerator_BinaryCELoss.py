...
# Unzip the dataset
local_zip = os.path.join(current_dir, "horse-or-human.zip") #'./horse-or-human.zip'
...
# Open a file dialog to select the image(s)
file_paths = filedialog.askopenfilenames(title='Choose Image(s)', filetypes=[('Image Files', '*.png;*.jpg;*.jpeg')])
